    ...
    useEffect(() => {
        if(user.available){
            ...
            for(let i=1;i<=daysInMonth;i++){
                ...
                let day = d.getDate();
                month = month < 10 ? '0'+month : month;  //put a zero on the left side if month below 10
                day = day < 10 ? '0'+day : day;         // put a zero on the left side if day below 10
                            ...
                            <TimeList horizontal={true} showsHorizontalScrollIndicator={false}>
                                {listHours.map((item, key) =>(
                                    ...
                                    >
                                        <TimeItemText
                                            style={{
                                                color: item === selectedHour ? '#000' : '#FFF',
